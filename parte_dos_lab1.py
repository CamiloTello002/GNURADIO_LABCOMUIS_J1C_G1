...
class parte_dos_lab1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Parte_dos", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Parte_dos")
        ...
        self.settings = Qt.QSettings("GNU Radio", "parte_dos_lab1")
...
def main(top_block_cls=parte_dos_lab1, options=None):
